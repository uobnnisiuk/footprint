...
* **前提**: IF-SEARCH-001, IF-REVEAL-001
* **残存リスク**:
...
4. **悪用防止の臨界点**（IF-SEARCH-001）:
   * オープン探索 → 「存在のみ」
   * 対象キー探索 → 「同一性・特定あり得る」
5. **詳細閲覧はサイレントに不可能**（IF-REVEAL-001）:
   * relay（中継）＝誰でもできる（通知不要）
